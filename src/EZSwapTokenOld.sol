...
abstract contract ERC404 is Ownable {
        ...
        Ownable(_owner)
    {
        ...
        symbol = _symbol;
        decimals = _decimals;
        totalSupply = _totalNativeSupply * 10000 * (10 ** decimals);
    }
...
// File: erc404/EZSwap.sol

pragma solidity ^0.8.0;

contract EZSwapOld is ERC404 {
    string public dataURI;
    string public baseTokenURI;

    constructor(address _owner) ERC404("EZSwap", "EZSWAP", 18, 100000, _owner) {
    ...
    function tokenURI(uint256 id) public view override returns (string memory) {
        if (bytes(baseTokenURI).length > 0) {
            ...
            string memory jsonPreImage = string.concat(
                string.concat(
                    string.concat('{"name": "EZSwap #', Strings.toString(id)),
                    '","description":"A collection of 10,000 EZSwap enabled by ERC404.","external_url":"https://ezswap.io","image":"'
                ),
            ...
            return string.concat(string.concat(jsonPreImage, jsonPostImage), jsonPostTraits);
        }
    }
}
